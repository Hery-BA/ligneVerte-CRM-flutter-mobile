...
class _RegionState extends State<Region> {
  ...
  _enAjoutant() async {
    ...
    if (form!.validate()) {
      form.save();
      _regionModel.idreg == 0
          ? await _dbHelper!.insertRegion(_regionModel)
          : await _dbHelper!.updateRegion(_regionModel);
      _enActualisant();
      _onreset();
    }
  }
              ...
              return Column(
                children: <Widget>[
                  ListTile(
                      ...
                      title: Text(
                        _regionList[index].nom_region.toUpperCase(),
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () async {
                          await _dbHelper!
                              .deleteRegion(_regionList[index].idreg);
                          _onreset();
                          _enActualisant();
                        },
                      ),
