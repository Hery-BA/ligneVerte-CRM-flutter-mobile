...
class _ProjectState extends State<Project> {
  ...
  _enAjoutant()async{
    ...
    if(form!.validate()){
    form.save();
    _projectModel.id==0? await _dbHelper!.insertProject(_projectModel): await _dbHelper!.updateProject(_projectModel);
    _enActualisant();
    // setState(() {
          ...
          return Column(
            children: <Widget>[
              ListTile(
                ...
                title: Text(_projects[index].project_name.toUpperCase(),
